...
<?php echo $__env->make('partials.stats_modal', ['id' => 'modalTotalAssets', 'title' => 'Daftar Seluruh Aset', 'items' => $listTotal], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php echo $__env->make('partials.stats_modal', ['id' => 'modalAvailableAssets', 'title' => 'Aset Tersedia', 'items' => $listAvailable], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

<?php
    $deployedList = \App\Models\Asset::with('holder')->where('status', 'deployed')->latest()->get();
?>
<?php echo $__env->make('partials.stats_modal', ['id' => 'modalDeployedAssets', 'title' => 'Aset Sedang Dipinjam', 'items' => $deployedList], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

<?php echo $__env->make('partials.stats_modal', ['id' => 'modalPendingRequests', 'title' => 'Daftar Request', 'items' => $listPending], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php echo $__env->make('partials.stats_modal', ['id' => 'modalMaintenanceAssets', 'title' => 'Aset Rusak', 'items' => $listMaintenance], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
</div><?php /**PATH C:\laragon\www\simaset_fix\resources\views/dashboard/modals.blade.php ENDPATH**/ ?>