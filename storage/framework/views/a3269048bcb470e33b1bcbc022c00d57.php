...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 mb-8">
    ...
    <div class="px-6 py-5 border-b border-gray-100 flex justify-between items-center bg-gray-50/50 rounded-t-xl">
        ...
        <a href="<?php echo e(route('borrowing.index')); ?>" class="inline-flex items-center gap-1 text-xs font-semibold text-indigo-600 bg-indigo-50 px-3 py-1.5 rounded-lg hover:bg-indigo-100 transition">
            Lihat Semua
                ...
                <tr class="hover:bg-gray-50 transition group">
                    ...
                    <td class="px-6 py-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="font-bold text-gray-900"><?php echo e($req->user->name); ?></p>
                    ...
                    <td class="px-6 py-4">
                        <div>
                            <p class="font-semibold text-indigo-600"><?php echo e($req->asset->name); ?></p>
                            <div class="flex items-center gap-2 mt-0.5">
                                <span class="text-xs font-mono text-gray-500 bg-gray-100 px-1.5 rounded border border-gray-200">
                                    <?php echo e($req->asset->serial_number); ?>

                                </span>
                                <span class="text-xs text-gray-400"><?php echo e($req->quantity); ?> Unit</span>
                            </div>
                        </div>
                    </td>
                        ...
                        <div class="max-w-xs">
                            <div class="flex items-start gap-1.5 mb-1.5">
                                ...
                                <p class="text-xs text-gray-600 italic leading-relaxed">
                                    "<?php echo e(Str::limit($req->reason, 60)); ?>"
                                </p>
                            </div>
                            <?php if($req->return_date): ?>
                                <div class="inline-flex items-center gap-1.5 text-[10px] font-medium text-blue-700 bg-blue-50 px-2 py-1 rounded border border-blue-100">
                                    ...
                                    Kembali: <?php echo e(\Carbon\Carbon::parse($req->return_date)->translatedFormat('d M Y')); ?>
                    ...
                    <td class="px-6 py-4 text-center">
                        <div class="flex items-center justify-center gap-2 opacity-100 sm:opacity-60 sm:group-hover:opacity-100 transition-opacity duration-200">
                            ...
                            <a href="<?php echo e(route('borrowing.show', $req->id)); ?>" 
                            ...
                            <form action="<?php echo e(route('borrowing.approve', $req->id)); ?>" method="POST" onsubmit="return confirm('Yakin setujui permintaan ini? Stok aset akan berkurang.')">
                                <?php echo csrf_field(); ?>
                                <button type="submit" 
                            ...
                            <button onclick="openRejectModal(<?php echo e($req->id); ?>, '<?php echo e($req->user->name); ?>', '<?php echo e($req->asset->name); ?>')" 
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 mb-8" id="activity-log">
    <div class="px-6 py-4 border-b border-gray-200 bg-gray-50 rounded-t-xl flex flex-col sm:flex-row justify-between items-center gap-4">
        ...
        <form action="<?php echo e(route('dashboard')); ?>" method="GET" class="relative w-full sm:w-64">
            <input type="text" name="search_log" value="<?php echo e(request('search_log')); ?>" placeholder="Cari aktivitas..." 
                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-6 py-3 whitespace-nowrap">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="font-medium text-gray-900"><?php echo e($log->user->name ?? 'Sistem'); ?></p>
                                <p class="text-[10px] text-gray-500"><?php echo e($log->user->role ?? '-'); ?></p>
                            </div>
                        </div>
                    </td>
                    ...
                    <td class="px-6 py-3 whitespace-nowrap">
                        ...
                        ?>
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($type['bg']); ?> <?php echo e($type['text']); ?>">
                    ...
                    <td class="px-6 py-3">
                        <p class="text-indigo-600 font-medium text-xs mb-0.5"><?php echo e($log->asset->name ?? 'Aset Tidak Dikenal'); ?></p>
...
</div><?php /**PATH C:\laragon\www\simaset_fix\resources\views/dashboard/admin_tables.blade.php ENDPATH**/ ?>