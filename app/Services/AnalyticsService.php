...
{
    /**  
     * narik data buat chartnya
     */
    public function getChartData($type, $mode, $startDate, $endDate)
    {
        switch ($type) {
            // 1. Biaya Maintenance
    ...
    /**
     * Get detail data for table
     */
    public function getDetailData($type, $startDate, $endDate) 
    {
        $headers = [];
        $rows = [];
        $title = 'Detail Data';
