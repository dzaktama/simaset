...
<div class="w-full px-4 sm:px-6 lg:px-8 py-6 bg-gray-50 min-h-screen">
    ...
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">Buat akun baru untuk karyawan atau administrator sistem.</p>
        </div>
            ...
            <div class="lg:col-span-4 space-y-5">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-5 space-y-4">
                        ...
                        <div class="group">
                            <label class="block text-sm font-bold text-gray-700 mb-1.5 group-focus-within:text-indigo-600">Password <span class="text-red-500">*</span></label>
