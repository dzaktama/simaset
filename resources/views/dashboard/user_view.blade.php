<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
        ...
        <p class="text-3xl font-bold text-indigo-600">{{ $activeAssetsCount ?? 0 }} <span class="text-sm text-gray-500 font-normal">Unit Aktif</span></p>
        <div class="mt-4">
            <a href="{{ route('assets.my') }}" class="text-sm font-medium text-indigo-600 hover:text-indigo-800">Lihat Detail &rarr;</a>
        </div>
    </div>
    
    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
        <h3 class="text-lg font-bold text-gray-800 mb-2">Permintaan Saya</h3>
        <p class="text-3xl font-bold text-yellow-600">{{ $pendingRequestsCount ?? 0 }} <span class="text-sm text-gray-500 font-normal">Pending</span></p>
        <div class="mt-4">
            <a href="{{ route('borrowing.index') }}" class="text-sm font-medium text-indigo-600 hover:text-indigo-800">Cek Status &rarr;</a>
        </div>
    </div>
</div>
