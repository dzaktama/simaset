                                ...
                                <tr class="bg-white hover:bg-gray-50 transition cursor-pointer" @click="expanded = !expanded">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-4">
                                            <div class="flex-shrink-0 h-12 w-12 rounded-lg overflow-hidden bg-gray-100 border border-gray-200 relative">
                                                @if($group->first()->image)
                                                    <img class="h-full w-full object-cover" src="{{ asset('storage/' . $group->first()->image) }}" alt="">
                                                @else
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex gap-1 flex-wrap">
                                            ...
                                            @endforeach
                                            <span class="px-2 py-0.5 rounded-full text-xs font-medium bg-indigo-50 text-indigo-700 border border-indigo-200">
                                    ...
                                    <tr x-show="expanded" 
                                        ...
                                        <td class="px-6 py-3 pl-10">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <div class="text-sm font-bold text-gray-700 font-mono">{{ $asset->serial_number }}</div>
                                                    <div class="text-[10px] text-gray-400">ID: {{ $asset->id }}</div>
                                                </div>
                                            </div>
                                        </td>

                                        {{-- Child Kolom 2: Lokasi Spesifik --}}
                                        <td class="px-6 py-3">
                                        ...
                                        {{-- Child Kolom 3: Status Spesifik --}}
                                        <td class="px-6 py-3">
                                            @if ($asset->status === 'available')
                                                <span class="px-2 py-0.5 rounded text-[10px] font-bold bg-green-100 text-green-700">Available</span>
                                            @elseif ($asset->status === 'deployed')
                                                <div class="flex flex-col">
                                                    <span class="px-2 py-0.5 rounded text-[10px] font-bold bg-blue-100 text-blue-700 w-fit">Deployed</span>
                                                    <span class="text-[10px] text-gray-500 mt-0.5">{{ $asset->holder->name ?? 'Unknown' }}</span>
                                                </div>
                                            @elseif ($asset->status === 'maintenance')
                                                <span class="px-2 py-0.5 rounded text-[10px] font-bold bg-yellow-100 text-yellow-700">Maintenance</span>
                                            @else
                                                <span class="px-2 py-0.5 rounded text-[10px] font-bold bg-red-100 text-red-700">Broken</span>
                                            @endif
                                        </td>

                                        {{-- Child Kolom 4: Full Actions --}}
